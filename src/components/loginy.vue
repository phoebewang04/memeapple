                ...
                <div class="mainLogin" v-if="currentlogin === 'login'">
                    <form @submit.prevent="submitLogin">
                        ...
                        <div class="checkforget">
                            <label for="onlogin">
                                <input type="checkbox" name="onlogin" id="onlogin" class="checkmark" checked><p>保持登入</p>
                            </label>
                            <a href="#">忘記密碼？</a>
                        </div>
                        <div class="linef">
                        ...
                        <ol id="mainJoin">
                            ...
                            <div class="checkservers_container">
                                <div class="checkservers">
                                    <label for="agreeTerms"><input type="checkbox" class="checkserver" v-model="agreeTerms" id="agreeTerms">
                                        <p>我同意 <router-link to="/Privacy/" target="_blank">隱私權政策</router-link> & <router-link to="/Terms/" target="_blank">服務條款</router-link></p></label>
                                </div>
