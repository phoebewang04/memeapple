  ...
  <!------- 進入畫面 ------->
    ...
    <div ref="scene1" class="scene esc_bathroom_container">
      ...
      <div class="esc_bath_icon">
        ...
        <img src="../assets/img/esc_04.png" ref="trash" class="esc_bath_trash" alt="垃圾" @click="removeTrash">
      </div>
    ...
    <div ref="scene2" class="scene esc_bedroom_container">
      ...
      <div class="esc_bed_exit">
        <img src="../assets/img/esc_01.png" alt="Bedroom Door" @click="escExit('')">
      </div>
      ...
      <div class="esc_bed_icon">
        ...
        <img ref="wastepaper" src="../assets/img/esc_11.png" alt="Wastepaper">
...
export default {
  ...
  methods: {
    ...
    // ],
    // paperClues(clueImages) {
    //   secAlert.fire({
    //     imageUrl: this.paperClues(clueImages[0]),
    //     html: '發現了線索！',
    //     showConfirmButton: false,
    //   });
    // },
